...
from projects.my_wizard_of_wikipedia.generator.transformer.universal_and_transformer import TransformerGeneratorAgent
from .transformer_universal_modules import EndToEndModel
